(this.webpackChunk=this.webpackChunk||[]).push([[271],{22525:function(e,t,n){var r={"./bardot.tsx":82556,"./custom-folder.tsx":7595,"./drop-bms.tsx":18800,"./error.tsx":14884,"./font.js":39230,"./online-authentication.tsx":1040,"./options.tsx":15950,"./quickpick.tsx":46812,"./ranking-table.tsx":43427,"./result.js":7956,"./skin.js":40357}
function a(e){var t=l(e)
return n(t)}function l(e){if(!n.o(r,e)){var t=new Error("Cannot find module '"+e+"'")
throw t.code="MODULE_NOT_FOUND",t}return r[e]}a.keys=function(){return Object.keys(r)},a.resolve=l,e.exports=a,a.id=22525},73675:function(e,t,n){"use strict"
var r=n(95970),a=n.n(r),l=n(50146),o=n.n(l)()(a())
o.push([e.id,".ranking-table-playground .Ranking {\n  background: #ddd;\n  margin: 10px;\n  display: inline-block;\n  width: 512px;\n  height: 256px;\n}","",{version:3,sources:["webpack://./devtools/playgrounds/ranking-table-playground.scss"],names:[],mappings:"AACE;EACE,gBAAA;EACA,YAAA;EACA,qBAAA;EACA,YAAA;EACA,aAAA;AAAJ",sourcesContent:[".ranking-table-playground {\n  .Ranking {\n    background: #ddd;\n    margin: 10px;\n    display: inline-block;\n    width: 512px;\n    height: 256px;\n  }\n}\n"],sourceRoot:""}]),t.Z=o},22578:function(e,t,n){"use strict"
n.r(t),n.d(t,{main:function(){return i}})
var r=n(6560),a=n(63929),l=n(95280),o=n(98711)
const s=function(e){const t={}
for(const n of e.keys()){t[n.match(/\w[^.]+/)[0]]=e(n)}return t}(n(22525))
class c extends a.Component{static main(){l.render(a.createElement(c,null),r.Z)}render(){const e={color:"#abc"}
return a.createElement("div",null,a.createElement("h1",null,"Bemuse Playground"),a.createElement("p",null,"Please select a playground"),a.createElement("ul",null,Object.keys(s).map((t=>a.createElement("li",null,a.createElement("a",{style:e,href:"?mode=playground&playground="+t},t))))))}}function i(){(s[o.Z.playground]||c).main()}},82556:function(e,t,n){"use strict"
n.r(t),n.d(t,{main:function(){return s}})
var r=n(63929),a=n(6560),l=n(95280),o=n(70415)
function s(){l.render(r.createElement(r.Fragment,null,r.createElement(o.q,{fill:"white",fraction:0}),r.createElement(o.q,{fill:"white",fraction:.25}),r.createElement(o.q,{fill:"white",fraction:.5}),r.createElement(o.q,{fill:"white",fraction:.67}),r.createElement(o.q,{fill:"white",fraction:.75}),r.createElement(o.q,{fill:"white",fraction:.8}),r.createElement(o.q,{fill:"white",fraction:1})),a.Z)}},7595:function(e,t,n){"use strict"
n.r(t),n.d(t,{main:function(){return m}})
var r=n(63929),a=n(62270),l=n.n(a),o=n(6560),s=n(95280),c=n(6946),i=n(94533)
const u=new c.QueryClient,d=()=>{const e=(0,i.k$)(),{isLoading:t,error:n,data:a}=(0,c.useQuery)("customFolder",(async()=>await(0,i.x9)(e))),[o,s]=r.useState("")
...
n.y=100,t.addChild(n),o(),console.log("Ok")})),a.Z.appendChild(e.view),o()}},1040:function(e,t,n){"use strict"
n.r(t),n.d(t,{main:function(){return c}})
var r=n(63929),a=n(95280),l=n(6560),o=n(84500)
const s=()=>r.createElement("div",null,r.createElement(o.Z,null))
function c(){a.render(r.createElement(s,null),l.Z)}},15950:function(e,t,n){"use strict"
n.r(t),n.d(t,{main:function(){return u}})
var r=n(63929),a=n(95280),l=n(6560),o=n(18864),s=n(64134)
const c=()=>{},i=()=>r.createElement(o.Z,{visible:!0,onBackdropClick:c},r.createElement(s.Z,{onClose:c}))
function u(){a.render(r.createElement(i,null),l.Z)}},46812:function(e,t,n){"use strict"
n.r(t),n.d(t,{main:function(){return a}})
var r=n(59615)
function a(){(async()=>{const e=await(0,r.Fe)(["one","two","three"].map((e=>({label:e}))),{title:"test"})
await(0,r.wp)("Result","You selected: "+e.label)})()}},43427:function(e,t,n){"use strict"
n.r(t),n.d(t,{main:function(){return A}})
var r=n(87672),a=n.n(r),l=n(95541),o=n.n(l),s=n(24324),c=n.n(s),i=n(26419),u=n.n(i),d=n(15669),m=n.n(d),f=n(95076),h=n.n(f),p=n(73675),E={}
E.styleTagTransform=h(),E.setAttributes=u(),E.insert=c().bind(null,"head"),E.domAPI=o(),E.insertStyleElement=m()
a()(p.Z,E),p.Z&&p.Z.locals&&p.Z.locals
var g=n(6560),b=n(77587),y=n(63929),w=n(95280)
const v=[{playerName:"One",score:543210,count:[5,4,3,2,1],total:15,rank:1},{playerName:"Two",score:123456,count:[1,2,3,4,5],total:15,rank:2}],k=()=>y.createElement("div",{className:"ranking-table-playground"},y.createElement(b.Z,{state:{data:v,meta:{scoreboard:{status:"completed",value:null},submission:{status:"completed",value:{playerName:"One",score:543210,count:[5,4,3,2,1],total:15,rank:1}}}}}),y.createElement(b.Z,{state:{data:v,meta:{scoreboard:{status:"completed",value:null},submission:{status:"completed",value:null}}}}),y.createElement(b.Z,{state:{data:null,meta:{scoreboard:{status:"completed",value:null},submission:{status:"unauthenticated"}}}}),y.createElement(b.Z,{state:{data:null,meta:{scoreboard:{status:"loading"},submission:{status:"loading"}}}}),y.createElement(b.Z,{state:{data:null,meta:{scoreboard:{status:"error",error:new Error},submission:{status:"error",error:new Error}}}}))
function A(){w.render(y.createElement(k,null),g.Z)}},7956:function(e,t,n){"use strict"
n.r(t),n.d(t,{main:function(){return c}})
var r=n(19989),a=n(63929),l=n(73373),o=n(20734),s=n(2622)
...
o.ZP.display(a.createElement(r.zt,{store:(0,s.Z)()},a.createElement(l.Z,{...e})))}},40357:function(e,t,n){"use strict"
n.r(t),n.d(t,{main:function(){return h}})
var r=n(8050),a=n(38044),l=n.n(a),o=n(35982),s=n.n(o),c=n(7194),i=n(81368),u=n(88371),d=n(47991),m=n(6560),f=n(88339)
async function h(){const e=s().Compiler.compile("\n    #TITLE ทดสอบ Bemuse\n    #ARTIST ฟหกด\n    #00111:01\n    #00112:01\n    #00113:01\n    #00114:01\n    #00115:01\n    #00118:01\n    #00119:01\n    #00116:01\n    #00151:0001010000000000\n    #00152:0001010000000000\n    #00153:0001010000000000\n    #00154:0001010000000000\n    #00155:0001010000000000\n    #00158:0001010000000000\n    #00159:0001010000000000\n    #00156:0001010000000000\n    #00211:010000000000000000010000\n    #00212:000100000000000000010000\n    #00213:010001000000000000010000\n    #00214:010000010000000001000001\n    #00215:010000000100000100000100\n    #00218:010000000010010001000100\n    #00219:010000000001000100000100").chart,t=[(0,f.fromBMSChart)(e)],n=new c.Z(t,{players:[{speed:2}]}),a=await r.load(r.getSkinUrl({displayMode:"touch3d"})),o=new r.Context(a),h=new i.Z({game:n,skin:a,context:o}),p=new d.Z(n),E=new u.Z,g=(new Date).getTime(),b={started:!0,startTime:g,readyFraction:0}
var y
...
e.style.width=Math.round(t*r)+"px",e.style.height=Math.round(n*r)+"px"}e.style.display="block",e.style.margin="0 auto",m.Z.appendChild(e),r(),l()(window).on("resize",r)}(o.view)}}}])

//# sourceMappingURL=playground-aa5b72ffd0bb990d7a91.js.map