"use strict";(this.webpackChunk=this.webpackChunk||[]).push([[948],{22022:function(t,e){e.Z=new AudioContext({latencyHint:"interactive"})},75349:function(t,e,s){var n=s(62270),o=s.n(n),r=s(38274),a=s(76177)
...
e&&e.stop()}}},38274:function(t,e,s){e.Z=class{constructor(t,e,s,{volume:n}={}){this._master=t,this._samples=e,this._map=s,this._exclusiveInstances=new Map,this._group=this._master.group({volume:n})}playAuto(t,e,s){return this._play({note:t,delay:e,exclusive:!0,slice:s})}playNote(t,e,s){return this._play({note:t,delay:e,exclusive:!0,slice:s})}playFree(t,e,s){return this._play({note:t,delay:0,exclusive:!1,slice:s})}_play({note:t,delay:e,exclusive:s}){const n=t.keysound
...
s&&(setTimeout((()=>s.stop()),1e3*e),this._exclusiveInstances.delete(t))}}},57317:function(t,e,s){var n=s(8666),o=s(28734)
...
return s.x-=e,s.y-=e,s.width+=2*e,s.height+=2*e,s}}},26215:function(t,e,s){var n=s(26230),o=s(62270),r=s.n(o),a=s(55481),i=s(45780),c=s.n(i),u=s(33256)
...
return[t,s]}catch(e){return console.error("Unable to load keysound: "+t,e),null}}_decode(t){return this._master.decode(t)}_getFile(t){return t=t.replace(/\\/g,"/"),this._assets.file(t.replace(/\.\w+$/,".ogg")).catch((()=>this._assets.file(t.replace(/\.\w+$/,".m4a")))).catch((()=>this._assets.file(t.replace(/\.\w+$/,".flac")))).catch((()=>this._assets.file(t.replace(/\.\w+$/,".mp3")))).catch((()=>this._assets.file(t)))}}},33237:function(t,e,s){var n=s(48274),o=s.n(n)
e.Z=function(){const t=new Map
let e
return{receiveSongId(s){e!==s&&(e=s,t.clear())},isEmpty(){return 0===t.size},isCached(e){return t.has(e)},cache(s,n){o()(e,"Expected current song to be set."),t.set(s,n)},get(e){return t.get(e)}}}},55481:function(t,e,s){var n=s(33237)
e.Z=(0,n.Z)()},80513:function(t,e,s){var n=s(57050),o=s(26230),r=s(2755),a=s(62270),i=s.n(a),c=s(75239),u=s.n(c),l=s(96011)
...
return(await n.load()).slice(e,s)}}},10426:function(t,e,s){s.d(e,{tz:function(){return a},u7:function(){return d}})
var n=s(22022),o=s(2755),r=s(52973)
...
if(79===s[0]&&103===s[1]&&103===s[2]&&83===s[3])return e((0,r.g)(this.audioContext,t))}this.audioContext.decodeAudioData(t,(function(t){e(t)}),(function(t){s(new Error("Unable to decode audio: "+t))}))}))}_startPlaying(t){this._instances.add(t)}_stoppedPlaying(t){this._instances.delete(t)}}},52973:function(t,e,s){s.d(e,{g:function(){return a}})
var n=s(75239)
let o
const r=s.n(n)()(1)
async function a(t,e){const n=await(o||(o=s.e(45).then(s.t.bind(s,3660,17)).then((t=>t.default)).then((t=>(0,eval)(t+"stbvorbis")))),o)
...
//# sourceMappingURL=948-dd55343324f16d6ecce1.js.map