/*! For license information please see comingSoonDemo-40c0484b0df83b37ba7a.js.LICENSE.txt */
...
return n?(e=parseFloat(n[1]),s=n[4].toLowerCase()):(e=parseInt(t,10),s="b"),isNaN(e)?null:Math.floor(r[s]*e)}},18680:function(t,e,n){"use strict"
var r=n(95970),o=n.n(r),s=n(50146),i=n.n(s)()(o())
...
o.createWithTimers=r,t.exports=o,t.exports.default=o},48274:function(t){"use strict"
t.exports=function(t,e,n,r,o,s,i,a){if(!t){var c
if(void 0===e)c=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.")
else{var u=[n,r,o,s,i,a],l=0;(c=new Error(e.replace(/%s/g,(function(){return u[l++]})))).name="Invariant Violation"}throw c.framesToPop=1,c}}},1588:function(t,e,n){"use strict"
...
return o(arguments[0],arguments[1])}return r=n,o},"function"==typeof Promise&&(t.exports.Promise=Promise)},22022:function(t,e){"use strict"
e.Z=new AudioContext({latencyHint:"interactive"})},86239:function(t,e,n){"use strict"
n.r(e),n.d(e,{main:function(){return k}})
var r=n(87672),o=n.n(r),s=n(95541),i=n.n(s),a=n(24324),c=n.n(a),u=n(26419),l=n.n(u),f=n(15669),h=n.n(f),p=n(95076),d=n.n(p),A=n(18680),g={}
...
var m=n(38044),b=n.n(m),y=n(17957),w=n(10426),_=n(22022),v=n(35982),E=n(57923),x=n.n(E),C=n(795).Buffer
...
return async function(t,e){const n=new w.ZP(_.Z),r=e.find(".js-log"),o=e.find(".js-play").hide(),s=e.find(".js-sampler")
m("Loading file list")
const i=(await t.fileList).filter((t=>t.match(/\.(?:bms|bme|bml|pms)$/i)))[0]
m("Loading "+i)
const a=await t.file(i),c=await a.read(),u=C.from(new Uint8Array(c)),l=await v.Reader.readAsync(u),f=v.Compiler.compile(l).chart,h=v.Timing.fromBMSChart(f),p=v.Notes.fromBMSChart(f),d=v.SongInfo.fromBMSChart(f)
...
r&&(r(),r=null)
n=t,n&&(r=n.watch(o))}(e.shift())}return{add(t){e.push(t),o()}}}},60016:function(t,e,n){"use strict"
function r(t,e,n){if(e.match(/\.(?:bms|bme|bml|bmson)/i))return void n(e)
const r=(t+e).split("/")
for(let t=0;t<r.length;t++)n(r.slice(t).join("/"))}n.d(e,{N:function(){return r}})},66529:function(t,e,n){"use strict"
n.d(e,{pS:function(){return l},AQ:function(){return h},xH:function(){return p},dG:function(){return d}})
var r=n(26230)
class o{constructor(){this.buffer=[],this.loggingFunction=t=>{this.buffer&&this.buffer.push(t)},this.log=t=>{this.loggingFunction(t)},this.setLoggingFunction=t=>{this.loggingFunction=t,this.buffer&&(this.buffer.forEach((e=>t(e))),this.buffer=null)}}}var s=n(1588),i=n(60016)
s.X.init({workerUrl:"/vendor/libarchive.js-1.3.0/dist/worker-bundle.js"})
var a=n(2755),c=n(57050),u=n(37057)
...
return{name:n,file:await(0,u.Z)(t).as("blob",o)}}},17957:function(t,e,n){"use strict"
var r=n(66529),o=n(60016)
...
n.push(...Array.from(t))}for(const r of n)await a(r,e+t.name+"/")}function l(t,e=""){t&&(0,o.N)(e,t.name,(e=>{n.push({name:e,file:t})}))}}(t,e)})}}e.Z=s},10426:function(t,e,n){"use strict"
n.d(e,{tz:function(){return i},u7:function(){return h}})
var r=n(22022),o=n(2755),s=n(52973)
...
if(79===n[0]&&103===n[1]&&103===n[2]&&83===n[3])return e((0,s.g)(this.audioContext,t))}this.audioContext.decodeAudioData(t,(function(t){e(t)}),(function(t){n(new Error("Unable to decode audio: "+t))}))}))}_startPlaying(t){this._instances.add(t)}_stoppedPlaying(t){this._instances.delete(t)}}},52973:function(t,e,n){"use strict"
n.d(e,{g:function(){return i}})
var r=n(75239)
let o
const s=n.n(r)()(1)
async function i(t,e){const r=await(o||(o=n.e(45).then(n.t.bind(n,3660,17)).then((t=>t.default)).then((t=>(0,eval)(t+"stbvorbis")))),o)
...
this.offset+=t.length}}},74278:function(t,e,n){"use strict"
...
return this._callbacks[e]=t,()=>delete this._callbacks[e]}}},37057:function(t,e,n){"use strict"
var r=n(26826),o=n.n(r),s=n(33256)
...
const r=e()
await o()(r)}}}}},65e3:function(t,e,n){"use strict"
var r=n(74278)
e.Z=class{constructor(t){this._callbacks=new r.Z,this._value=t}get value(){return this._value}set value(t){this._value=t,this.notify(t)}notify(t){this._callbacks.call(t)}watch(t){return void 0!==this._value&&t(this._value),this._callbacks.add(t)}}},2755:function(t,e,n){"use strict"
...
//# sourceMappingURL=comingSoonDemo-40c0484b0df83b37ba7a.js.map