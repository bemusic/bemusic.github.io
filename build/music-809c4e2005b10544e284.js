/*! For license information please see music-809c4e2005b10544e284.js.LICENSE.txt */
...
var f=(e/r[u.toLowerCase()]).toFixed(l)
return c||(f=f.replace(n,"$1")),o&&(f=f.split(".").map((function(e,n){return 0===n?e.replace(t,o):e})).join(".")),f+i+u}function o(e){if("number"==typeof e&&!isNaN(e))return e
...
let i,l,c
const u=e||clearTimeout,f=()=>{u(i),c(t())},d=new Promise(((e,t)=>{l=()=>{o&&o.removeEventListener("abort",f),r?e(a):t(a)},c=t,i=(n||setTimeout)(l,s)}))
return o&&o.addEventListener("abort",f,{once:!0}),d.clear=()=>{u(i),i=null,l()},d},r=e=>{const t=n({...e,willResolve:!0})
return t.reject=n({...e,willResolve:!1}),t.range=(e,n,r)=>t(((e,t)=>Math.floor(Math.random()*(t-e+1)+e))(e,n),r),t},s=r()
s.createWithTimers=r,e.exports=s,e.exports.default=s},76358:function(e,t,n){"use strict"
n.r(t),n.d(t,{main:function(){return U}})
var r=n(95612),s=n(6560),a=n(63929),o=n(95280),i=n(21081),l=n(62270),c=n.n(l),u=n(90928),f=n(21141),d=n(16562),h=n(76819),m=n(6227)
const p={ingame:e=>(0,h.Z)((0,m.Z)(e)),added:e=>[{title:"Sorted by added date",songs:c().reverse(c().sortBy(e,b))}]},b=e=>e.added||(e.initial?"0000-00-00":"9999-99-99")
const g=({song:e})=>{const t=function(e){const t=[],n=(e,...n)=>t.push({keys:n,message:e})
...
r(n)}},e.genre),a.createElement("br",null),a.createElement("strong",{onClick:()=>{console.log(e),alert(n(85331).inspect(e))}},e.title),a.createElement("br",null),e.artist),a.createElement("td",null,a.createElement(g,{song:e}))),y=({sort:e,songs:t,url:n,setPreviewUrl:r})=>{const s=p[e](t),o=[]
...
try{return a.createElement(_,{data:e,url:t,initialSort:n})}catch(e){return a.createElement(k,{text:`Error: ${e}`})}},x=n(99909),P=n(98711)
var S=()=>{const[e,t]=(0,a.useState)("Loading"),[n,r]=(0,a.useState)(null),s=P.Z.server||i.p_
return(0,a.useEffect)((()=>{(0,i.zD)(s).then((e=>{t("Load completed"),r(e)}),(e=>{t("Load error: "+e)}))}),[]),a.createElement("div",null,a.createElement("header",{style:{textAlign:"center"}},a.createElement("h1",null,"Bemuse collection viewer"),a.createElement("div",null,s,a.createElement("br",null),e)),a.createElement("div",{style:{padding:20}},a.createElement(Z,{data:n&&(0,x.Z)(n),url:s,initialSort:P.Z.sort})))}
function U(){r.MA(),(0,o.render)(a.createElement(S,null),s.Z)}},21141:function(e,t,n){"use strict"
...
var r=n(62270),s=n.n(r),a=n(29893)
t.Z=function(e){return s().orderBy(e,[e=>s()(e.charts).filter(a.Z).filter((e=>e.info.difficulty<5)).filter((e=>e.info.level>0)).map((e=>e.info.level)).min(),e=>e.bpm,e=>e.title.toLowerCase()])}},90928:function(e,t,n){"use strict"
var r=n(63929),s=n(95612)
s.MA()
t.Z=({url:e})=>((0,r.useEffect)((()=>{const e=({data:e})=>{"calibration-started"===e.type?s.h$():"calibration-closed"===e.type&&s.wp()}
return addEventListener("message",e),()=>{s.h$(),removeEventListener("message",e)}}),[]),(0,r.useEffect)((()=>{s.wp(),s.RN(e)})),null)},95612:function(e,t,n){"use strict"
...
//# sourceMappingURL=music-809c4e2005b10544e284.js.map