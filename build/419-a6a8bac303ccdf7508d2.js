...
var o=n(80342),r=n(14865),i=n(63929),s=n(95280),a=n(87672),u=n.n(a),c=n(95541),l=n.n(c),h=n(24324),d=n.n(h),f=n(26419),g=n.n(f),m=n(15669),p=n.n(m),_=n(95076),b=n.n(_),y=n(3101),v={}
...
return Math.floor(t/60)+":"+(e<10?"0":"")+e}},80342:function(t,e,n){var o=n(35741),r=n.n(o)
const i=n(58028).forModule("timesynchro")
let s,a=0
s=window.performance&&"function"==typeof window.performance.now?()=>window.performance.now():()=>Date.now(),s.synchronize=function(t){function e(t){a=t+Date.now()-s()}r()(t,(function(t,n){t?i.error("Cannot synchronize time: "+t):(e(n),i.info("Synchronized time with global server! Offset = "+a))}),e)},s.synchronized=function(){const t=a
return()=>s()+t},e.Z=s},65e3:function(t,e,n){var o=n(74278)
...
//# sourceMappingURL=419-a6a8bac303ccdf7508d2.js.map