...
t.setAttribute("style","\n        position: fixed;\n        top: 20px;\n        left: 20px;\n        font: 20px Comic Sans MS, sans-serif;\n        z-index: 99999;\n        background: rgba(0,0,0,0.5);\n        color: #0f0;\n        border: 2px solid #0f0;\n        padding: 4px;\n        pointer-events: none;\n      "),t.innerHTML="\n      <strong>Test mode:</strong>\n      Bemuse is being controlled by automated test software.\n    ",document.body.appendChild(t)}}function s(t){console.log("[Bemuse test mode] A pause handler has been registered."),r=t}function a(){return!!o}function u(t){return r.pauseAt(t)}function c(){return r.unpause()}function l(){return r.getScore()}},28734:function(t,e,n){n.d(e,{Z:function(){return E}})
...
const w=({stats:t})=>i.createElement("table",null,i.createElement("tbody",null,Object.keys(t).map((e=>{const n=t[e]
return i.createElement("tr",{key:e},i.createElement("td",null,i.createElement("strong",null,e)),i.createElement("td",{align:"right"},""+n))}))))
var S=({bench:t})=>{const[e,n]=(0,i.useState)(!1),[,o]=(0,i.useState)(!1);(0,i.useEffect)((()=>{const t=setInterval((()=>o((t=>!t))),1e3)
return()=>{clearInterval(t)}}),[])
const r=t=>{t.preventDefault(),t.stopPropagation(),n((t=>!t))}
return i.createElement("div",{className:"BenchmarkPanel",onClick:r,onTouchStart:r},e?i.createElement("article",null,i.createElement("b",null,"Benchmark Stats"),i.createElement("br",null),i.createElement(w,{stats:t.stats})):"Show Benchmark Stats")}
function M(){let t=0,e=0,n=0
const r=[]
let i=0,s=0
return{push:function(a){const u=(0,o.Z)()
for(t+=a,e+=1,n=t/e,i+=a,r.push({delta:a,time:u});r[0]&&r[0].time<u-1e3;)i-=r.shift().delta
s=i/r.length},toString(){return x(n)+" / "+x(s)}}}function x(t){return t.toFixed(2)+"ms"}var E=window.BEMUSE_BENCHMARK=(0,r.gy)()?new function(){const t={},e={enabled:!0,stats:t,wrap(e,n){return function(){const r=(0,o.Z)()
try{return n.apply(this,arguments)}finally{const n=(0,o.Z)();(t[e]||(t[e]=new M(e))).push(n-r)}}},benchmark(t,e,n){e[n]=this.wrap(t,e[n])},toString(){const e=[]
return Object.keys(t).forEach((function(n){e.push("- "+n+": "+t[n])})),e.join("\n")}},n=document.createElement("div")
return n.setAttribute("style","position:fixed;top:10px;right:10px;z-index:99999"),document.body.appendChild(n),s.render(i.createElement(S,{bench:e}),n),e}:new function(){return{enabled:!1,wrap:(t,e)=>e}}},14865:function(t,e,n){n.d(e,{T_:function(){return r},Xb:function(){return c},ZB:function(){return s},gy:function(){return i},mq:function(){return u},oh:function(){return a}})
var o=n(98711)
...
var o=class{constructor(){this.value=0,this.changed=!1}get justPressed(){return this.changed&&this.value}},r=n(62270),i=n.n(r),s=n(28734)
...
//# sourceMappingURL=419-368f459a71eeb62aea3f.js.map