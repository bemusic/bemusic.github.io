...
var g=n(93981),b=n(62270),y=n.n(b)
const _={x:0,width:61},v={x:62,width:34,highlight:!0},w={x:97,width:26},E={x:159,width:26}
class B{constructor(e){let t=0
const n=(e,n)=>{const r=t
return t+=e+1,{x:r,width:e,column:n}},r=(e,t)=>({...n(e.width,t),sprite:e})
this.columns=e.split(" ").map((e=>"-"===e?n(72,null):e.endsWith("s")?r(_,e.slice(0,-1)):e.endsWith("b")?r(w,e.slice(0,-1)):e.endsWith("g")?r(E,e.slice(0,-1)):r(v,e))),this.totalWidth=t,this.columnMapping=y().fromPairs(this.columns.filter((e=>null!=e.column)).map((e=>[e.column,e])))}}const S=e=>{const t="SCs 1 2b 3 4g 5 6b 7 - 8 9b 10 11g 12 13b 14 SC2s",n=C("/skins/default/Note/DX/Note.png"),r=C("/skins/default/Note/DX/Landmine.png"),o=g.useRef(null),i=(0,g.useMemo)((()=>new B(t)),[t]),a=i.totalWidth+1,s=468,u=(0,g.useMemo)((()=>e.notechartPreview.getViewport(e.previewState.currentTime,e.previewState.hiSpeed)),[e.notechartPreview,e.previewState.currentTime,e.previewState.hiSpeed]),c=e.notechartPreview.getMaxCombo(),l=(0,g.useMemo)((()=>e.notechartPreview.getComboInfo(e.previewState.currentTime)),[e.notechartPreview,e.previewState.currentTime])
return(0,g.useEffect)((()=>{var t,d
const m=null===(t=o.current)||void 0===t?void 0:t.getContext("2d")
if(m){m.fillStyle="#000",m.fillRect(0,0,a,s)
for(const e of i.columns)m.fillStyle="#555",m.fillRect(e.x,0,1,s),(null===(d=e.sprite)||void 0===d?void 0:d.highlight)&&(m.fillStyle="#111",m.fillRect(e.x+1,0,e.width,s))
m.fillStyle="#555",m.fillRect(i.totalWidth,0,1,s),m.textAlign="center",m.font="bold 18px sans-serif"
for(const e of u.visibleBarLines){const t=Math.round(s-e.y*s)
m.fillRect(0,t-1,i.totalWidth,1),m.fillText("#"+e.measureNumber,i.totalWidth/2,t-4)}if(n&&r)for(const e of u.visibleNotes){const t=i.columnMapping[e.gameEvent.column]
if(null==t?void 0:t.sprite){const o=Math.round(s-e.y*s)
if(e.long){const r=Math.round(s-e.long.endY*s),i=e.long.active?100:0
m.drawImage(n,t.sprite.x,104+i,t.width,8,t.x+1,o-8,t.width,8),m.drawImage(n,t.sprite.x,12+i,t.width,8,t.x+1,r-12,t.width,8)
const a=o-r-4
a>0&&m.drawImage(n,t.sprite.x,22+i,t.width,64,t.x+1,r-4,t.width,a)}else{const i="landmine"===e.type?r:n
m.drawImage(i,t.sprite.x,0,t.width,12,t.x+1,o-12,t.width,12)}}}if(l){const t=e.previewState.currentTime-l.comboTime,n=Math.max(0,1-t)
n>0&&(m.fillStyle="rgba(255, 255, 255, "+n+")",m.font="bold 36px sans-serif",m.textAlign="center",m.fillText(`${l.comboCount} / ${c}`,i.totalWidth/2,404-n**8*8))}}}),[a,s,i,u,n,c,l,e.previewState.currentTime]),g.createElement("canvas",{ref:o,width:a,height:s,style:{imageRendering:"pixelated"}})}
function C(e){const[t,n]=g.useState(null)
return(0,g.useEffect)((()=>{const t=new Image
return t.src=e,t.onload=()=>n(t),()=>{t.onload=null}}),[e]),t}var P=n(20141),x={}
x.styleTagTransform=f(),x.setAttributes=l(),x.insert=u().bind(null,"head"),x.domAPI=a(),x.insertStyleElement=m()
o()(P.Z,x),P.Z&&P.Z.locals&&P.Z.locals
var T=n(97311)
const M=e=>{const t=e.notechartPreview,n=(0,g.useMemo)((()=>e.notechartPreview.getMeasureInfo(e.previewState.currentTime)),[e.notechartPreview,e.previewState.currentTime]),r=(0,g.useMemo)((()=>e.notechartPreview.getCurrentBpm(e.previewState.currentTime)),[e.notechartPreview,e.previewState.currentTime]),o=(0,g.useMemo)((()=>e.notechartPreview.getCurrentScroll(e.previewState.currentTime)),[e.notechartPreview,e.previewState.currentTime]),i=(0,g.useMemo)((()=>e.notechartPreview.getCurrentSpeed(e.previewState.currentTime)),[e.notechartPreview,e.previewState.currentTime]),a=e.previewState.hiSpeed,s=e=>e.toFixed(2),u=e=>`${~~(e/60)}:${(~~e%60).toString().padStart(2,"0")}`,c=(0,g.useMemo)((()=>g.createElement("p",{className:"PreviewInfoのkeyHints"},g.createElement("kbd",null,"Space")," Play/Pause",g.createElement("br",null),g.createElement("kbd",null,"Up/Down/Left/Right/,/.")," Seek",g.createElement("br",null),g.createElement("kbd",null,"G")," Go To Measure",g.createElement("br",null),g.createElement("kbd",null,"1/2")," Hi-Speed",g.createElement("br",null),g.createElement("kbd",null,"R")," Reload Chart")),[])
return g.createElement("div",{className:"PreviewInfo"},g.createElement("h2",null,t.name),g.createElement("p",null,t.description),g.createElement("table",null,g.createElement("col",{width:80}),g.createElement("col",{width:120}),g.createElement("col",{width:80}),g.createElement("tbody",null,g.createElement("tr",null,g.createElement("th",{scope:"row"},"Time"),g.createElement("td",{colSpan:2},u(e.previewState.currentTime)," /"," ",u(e.notechartPreview.duration))),g.createElement("tr",null,g.createElement("th",{scope:"row"},"Measure"),g.createElement("td",{colSpan:2},g.createElement(k,{measureInfo:n})," #",n.measureNumber)),g.createElement("tr",null,g.createElement("th",{scope:"row"},"#BPM"),g.createElement("td",null),g.createElement("td",null,s(r))),g.createElement("tr",null,g.createElement("th",{scope:"row"},"#SCROLL"),g.createElement("td",null,s(o),"x →"),g.createElement("td",null,s(r*o))),g.createElement("tr",null,g.createElement("th",{scope:"row"},"#SPEED"),g.createElement("td",null,s(i),"x →"),g.createElement("td",null,s(r*o*i))),g.createElement("tr",null,g.createElement("th",{scope:"row"},"HI-SPEED"),g.createElement("td",null,s(a),"x →"),g.createElement("td",null,s(r*o*i*a))))),c)},k=e=>{const{measureInfo:t}=e
...
for(;r<=2;)o/=2,r*=2
const i=[]
let a=Math.ceil((t.currentBeat-t.measureStartBeat)/o)
for(;r>0;)i.push(g.createElement(T.q,{key:i.length,fraction:r>1?1:r,fill:a>0?"#e34e7a":"#333"})),r--,a--
return g.createElement(g.Fragment,null,i)}
var N=n(50403)
const O=e=>((0,g.useEffect)((()=>{const t=e=>{e.preventDefault()},n=async t=>{t.preventDefault()
...
const s=await(0,N.Fe)(a,{title:"Select a chart file"})
...
return this._notechart.beatToSeconds(t)}getMeasureJumpTarget(e,t){const n=this._secondsToBeat(e),r=y().minBy(this._notechart.barLines,(e=>Math.abs(e.beat-n)))
if(!r)return e
...
const t=new $(this._samplingMaster,this._soundGroup,this._sortedSoundEvents,this._notechart.keysounds,this._samples,e)
return t.play(),t}}class ${constructor(e,t,n,r,o,i){this._samplingMaster=e,this._soundGroup=t,this._sortedSoundEvents=n,this._keysounds=r,this._delegate=i,this._cursor=0,this._sampleMap=new Map,this._startAudioTime=0,this._startSongTime=0,this._stopped=!1,this._playingSamples=new Map
...
this._playingSamples.clear()}}class H{constructor(e){this._events=y().sortBy(y().flatMap(e,(e=>e.end?[e.time,e.end.time]:[e.time])),y().identity)}getComboInfo(e){const t=y().sortedLastIndex(this._events,e)
if(0===t)return null
return{comboCount:t,comboTime:this._events[t-1]}}getMaxCombo(){return this._events.length}}const W="previewer-fs-handle",K=y().once((()=>{const e=new Z.ZP,t=Math.pow(10,-.41),n=e.group({volume:t})
return{samplingMaster:e,group:n}})),q=new Map
let V=""
async function z(e){const t=e.log||(e=>console.log(`[PreviewLoader] ${e}`))
t("Loading directory handle from IndexedDB")
const n=await(0,J.U2)(W),r=n.directory,o=n.handleId
t("Obtaining permission to read directory"),await async function(e){let t=await e.queryPermission({mode:"read"})
try{"prompt"===t&&(t=await e.requestPermission({mode:"read"}))}catch(n){await(0,N.wp)("File system access required","Please allow access to the filesystem."),t=await e.requestPermission({mode:"read"})}if("granted"!==t)throw new Error("Permission denied.")}(r),t("Scanning charts")
const i=[]
...
const s=new(I()),u=await(await a.handle.getFile()).arrayBuffer(),c=await s.load(u,{name:a.name},{scratch:"left",double:!0})
t("Loading samples")
const{samplingMaster:l,group:d}=K()
let m=0
V!==o&&(q.clear(),V=o)
const h=await R()(c.samples,(async e=>{if(q.has(e)){const t=q.get(e)||null
...
return t(`Loaded ${e} [${i}]: ${o.duration}s`),q.set(e,o),{filename:e,sample:o}}catch(n){return console.error(n),t(`Failed to load ${e}: ${n}`),{filename:e,sample:null}}}),{concurrency:64})
console.log(h),t("Loading preview")
const f=function(e,t,n,r,o){return new U(e,t,n,r,o)}(c,a.name,l,d,h)
return console.log(f),f}function X(e,t){let n=e
return t.loaded&&(n={...e,playing:!1}),t.speedUp&&(n={...e,hiSpeed:+Math.min(e.hiSpeed+.25,99).toFixed(2)}),t.speedDown&&(n={...e,hiSpeed:+Math.max(e.hiSpeed-.25,.25).toFixed(2)}),t.play&&(n={...e,playing:!0}),t.pause&&(n={...e,playing:!1}),t.playPause&&(n={...e,playing:!e.playing}),t.playFinish&&(n={...e,playing:!1}),t.home&&(n={...e,playing:!1,currentTime:0}),t.updateTime&&(n={...e,currentTime:t.updateTime.time}),t.jumpToTime&&(n={...e,currentTime:t.jumpToTime.time,playing:!1}),t.jumpByMeasure&&(n={...e,currentTime:t.jumpByMeasure.preview.getMeasureJumpTarget(e.currentTime,t.jumpByMeasure.direction),playing:!1}),t.jumpBySeconds&&(n={...e,currentTime:Math.max(0,e.currentTime+t.jumpBySeconds.direction),playing:!1}),n}let Q=null
const Y=e=>{const t=function(e){const t=(0,g.useRef)(e)
return(0,g.useEffect)((()=>{t.current=e}),[e]),(0,g.useCallback)((()=>t.current),[])}(e.notechartPreview)
return(0,g.useEffect)((()=>{const n=n=>{if(!(0,N.T)()){if(console.log(n.key),"2"===n.key&&(e.dispatch({speedUp:!0}),n.preventDefault()),"1"===n.key&&(e.dispatch({speedDown:!0}),n.preventDefault())," "===n.key&&(e.dispatch({playPause:!0}),n.preventDefault()),"Home"===n.key&&(e.dispatch({home:!0}),n.preventDefault()),"g"===n.key){e.dispatch({pause:!0})
const r=+(prompt("Measure number",Q?`${Q}`:"")||"")
isNaN(r)||(Q=r,e.dispatch({jumpToTime:{time:t().measureToSeconds(r)}})),n.preventDefault()}"r"!==n.key||n.ctrlKey||n.metaKey||(e.onReload(),n.preventDefault()),"ArrowDown"===n.key&&(e.dispatch({jumpByMeasure:{direction:-1,preview:t()}}),n.preventDefault()),"ArrowUp"===n.key&&(e.dispatch({jumpByMeasure:{direction:1,preview:t()}}),n.preventDefault()),"ArrowLeft"===n.key&&(e.dispatch({jumpBySeconds:{direction:-5}}),n.preventDefault()),"ArrowRight"===n.key&&(e.dispatch({jumpBySeconds:{direction:5}}),n.preventDefault()),","===n.key&&(e.dispatch({jumpBySeconds:{direction:-.1}}),n.preventDefault()),"."===n.key&&(e.dispatch({jumpBySeconds:{direction:.1}}),n.preventDefault())}}
return window.addEventListener("keydown",n),()=>{window.removeEventListener("keydown",n)}}),[e.dispatch]),null},ee=()=>{const e=(0,g.useRef)(null),[t,n]=(0,g.useReducer)(X,{currentTime:0,hiSpeed:1,playing:!1}),[r,o]=(0,g.useState)(G),[i,a]=(0,g.useState)(null),s=()=>{a("Loading...")
const t=y().throttle(a,100)
z({log:e=>{t((t=>null!=t?e:t))}}).then((t=>{o(t),n({loaded:!0}),e.current&&e.current.focus()})).catch((e=>{console.error(e),(0,N.wp)("Error loading preview",String(e))})).finally((()=>t(null)))}
!function(e,t,n){const r=(0,g.useRef)(null);(0,g.useEffect)((()=>{e.playing&&null===r.current?r.current=n.play({startTime:e.currentTime,onFinish:()=>{t({playFinish:!0})},onTimeUpdate:e=>{t({updateTime:{time:e}})}}):e.playing||null===r.current||(r.current.stop(),r.current=null)}),[e])}(t,n,r),(0,g.useEffect)((()=>{(async()=>{const e=await async function(){const e=await(0,J.U2)(W),t=null==e?void 0:e.chartFilename
return t?{chartFilename:t}:null}()
if(e){const t=[{label:`Load ${e.chartFilename}`,action:()=>{s()}},{label:"Do not load",action:()=>{}}];(await(0,N.Fe)(t,{title:"Load a recent song?"})).action()}})()}),[])
return g.createElement("div",{className:"BemusePreviewer",tabIndex:0,ref:e},g.createElement("div",{className:"BemusePreviewerのheader"},g.createElement("h1",null,g.createElement("a",{href:"https://bemuse.ninja/project/docs/previewer.html",target:"_blank",rel:"noreferrer"},g.createElement("strong",null,"Bemuse"),"’s BMS/bmson previewer"))),g.createElement("div",{className:"BemusePreviewerのmain"},g.createElement(S,{notechartPreview:r,previewState:t}),g.createElement(M,{notechartPreview:r,previewState:t}),g.createElement(O,{onDrop:async(e,t)=>{await async function(e,t){await(0,J.t8)(W,{directory:e,chartFilename:t,handleId:D().generate()})}(e,t),s()}}),g.createElement(Y,{notechartPreview:r,dispatch:n,onReload:()=>{s()}})),null!=i?g.createElement("div",{className:"BemusePreviewerのloading"},i):null)}
var te=n(10488)
function ne(){te.J.render(g.createElement(ee,null))}},37126:function(e,t,n){n.d(t,{tz:function(){return a},u7:function(){return m}})
var r=n(41377),o=n(18649),i=n(30637)
...
if(79===n[0]&&103===n[1]&&103===n[2]&&83===n[3])return t((0,i.g)(this.audioContext,e))}this.audioContext.decodeAudioData(e,(function(e){t(e)}),(function(e){n(new Error("Unable to decode audio: "+e))}))}))}_startPlaying(e){this._instances.add(e)}_stoppedPlaying(e){this._instances.delete(e)}}},30637:function(e,t,n){n.d(t,{g:function(){return a}})
var r=n(75239)
let o
const i=n.n(r)()(1)
async function a(e,t){const r=await(o||(o=n.e(45).then(n.t.bind(n,9872,17)).then((e=>e.default)).then((e=>(0,eval)(e+"stbvorbis")))),o)
...
this.offset+=e.length}}},73038:function(e,t,n){n.d(t,{Z:function(){return _}})
var r=n(87672),o=n.n(r),i=n(95541),a=n.n(i),s=n(24324),u=n.n(s),c=n(26419),l=n.n(c),d=n(15669),m=n.n(d),h=n(95076),f=n.n(h),p=n(79759),A={}
A.styleTagTransform=f(),A.setAttributes=l(),A.insert=u().bind(null,"head"),A.domAPI=a(),A.insertStyleElement=m()
o()(p.Z,A),p.Z&&p.Z.locals&&p.Z.locals
var g=n(93981),b=n(30583),y=n.n(b)
var _=({className:e,title:t,children:n})=>g.createElement("div",{className:y()("Panel",e)},g.createElement("div",{className:"Panelのtitle"},t),g.createElement("div",{className:"Panelのcontent"},n))},10488:function(e,t,n){n.d(t,{J:function(){return i}})
var r=n(21112)
const o=document.querySelector("#scene-root")
if(!o)throw new Error("The scene root element `#scene-root` not found")
const i=(0,r.s)(o)
t.Z=o},18649:function(e,t,n){t.Z=function(e){return{as(t){return new Promise((function(n,r){const o=new FileReader
...
break
case"text":o.readAsText(e)}}))}}}},69608:function(e,t){t.Z=document.querySelector("#warp-root")},96008:function(e,t,n){var r=this&&this.__createBinding||(Object.create?function(e,t,n,r){void 0===r&&(r=n)
...
//# sourceMappingURL=previewer-b28215a5974b012110c7.js.map